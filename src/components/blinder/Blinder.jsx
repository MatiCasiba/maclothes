                ...
                <div className="lg:container mx-auto">
                    ...
                    <div className="flex items-center justify-between gap-8">
                        <div className="flex items-center gap-3">
                            <button><FaHandHoldingHeart size={'2.5rem'} /></button>
                            <div>
                        ...
                        <div className="flex items-center gap-3">
                            <button><FaAward size={'2.5rem'} /></button>
                            <div>
                        ...
                        <div className="flex items-center gap-3">
                            <button><FaShippingFast size={'2.5rem'} /></button>
                            <div>
                                <h4 className="text-xl text-[#484848] font-poppins font-medium capitalize mb-2">free shipping</h4>
                                <span className="text-base text-[#484848] font-poppins font-normal">oder over 20$</span>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <button><IoCall size={'2.5rem'} /></button>
                            <div>
